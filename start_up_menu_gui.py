...
class StartUpMenu:
    def __init__(self):
        ...
        self._start_up_menu_window.config(background = "green")
        #default size of window + starting position on screen
        self._start_up_menu_window.geometry("435x350+500+200")
        ...
        self._logo_label = tkinter.Label(master = self._start_up_menu_window, image = self.my_img,background = 'green',pady = 10)
        ...
        self._row_frame = tkinter.Frame(master = self._start_up_menu_window,background = 'green')
        self._row_frame.grid(row = 2, column = 0)
        #Rows label
        self._row_label = tkinter.Label(master = self._row_frame,text = 'Rows:',font = FONT,background = 'green')
        ...
        self._row_menu.config(bg = 'green')

        #Cols Selection Dropdown
        #Frame encapsulates the 'Cols' label and the dropdown in row 2, col 1 of the window
        self._cols_frame = tkinter.Frame(master = self._start_up_menu_window,background = 'green')
        self._cols_frame.grid(row = 2, column = 1)
        #Cols label
        self._column_label = tkinter.Label(master = self._cols_frame,text = 'Columns:',font = FONT,background = 'green')
        ...
        self._cols_menu.config(bg = 'green')
        
        #First Player Selection Dropdown
        #Frame encapsulates the 'First Player' label and the dropdown in row 3, col 0 of the window
        self._player_frame = tkinter.Frame(master = self._start_up_menu_window,background = 'green')
        self._player_frame.grid(row = 3, column = 0, pady=10)
        #First Player label
        self._player_label = tkinter.Label(master = self._player_frame,text = 'First Player:',font = FONT,background = 'green')
        ...
        self._player_menu.config(bg = 'green')
        
        #Victory Type Selection Dropdown
        #Frame encapsulates the 'First Player' label and the dropdown in row 3, col 1 of the window
        self._type_frame = tkinter.Frame(master = self._start_up_menu_window,background = 'green')
        self._type_frame.grid(row = 3, column = 1, padx = 10, pady = 10)
        #Victory Type label
        self._type_label = tkinter.Label(master = self._type_frame,text = 'Victory Type:',font = FONT,background = 'green')
        ...
        self._type_menu.config(bg = 'green')
